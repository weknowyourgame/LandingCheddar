...
const logos = [
	{
		name: "Telegram",
		url: <Telegram className="w-24 h-24 brightness-100 invert-1 mx-10" />,
	},
	{
		name: "Discord",
		url: <Discord className="w-24 h-24 brightness-100 invert-1 mx-10" />,
	},
	{
		name: "Twitter",
		url: <Twitter className="w-24 h-24 brightness-100 invert-1 mx-10" />,
	},
];
	...
	return (
		<div className="py-2 max-w-4xl scale-75">
			<p className="font-normal tracking-tighter text-base text-gray-100 bg-gradient-to-br from-zinc-400 via-zinc-300 to-zinc-700 bg-clip-text text-transparent text-center mt-4">
				Works perfectly with your favourite apps.
			</p>
			{/* <hr className="h-[0.1px]  relative bg-white/10" /> */}

			<div className="relative bg-page-gradient h-full mx-auto max-w-full p-4">
					...
					{Array(3)
						...
						.map((index) => (
							<div
								...
								className="flex flex-row gap-18 justify-around items-center animate-logo-cloud shrink-0"
							>
								{logos.map((logo, key) => (
									<>{logo.url}</>
								))}
