...
function Cta() {
	return (
		...
		>
			...
			<div className="absolute top-0 z-0 w-screen  right-0 mx-auto h-[500px] overflow-hidden bg-inherit  bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(255,255,204,0.3),rgba(255,255,255,0)]"></div>
